...
object Queries {
    ...
    fun getReadByPageQuery(pageNumber: Int): SimpleSQLiteQuery {
        val simpleQuery =
            StringBuilder().append("SELECT id, sora, jozz, aya_no, page,aya_text, aya_text_emlaey, translation_id, sora_name_ar, sora_name_en, footnotes_id, translation_en, footnotes_en, sora_descend_place FROM quran WHERE page = ")
